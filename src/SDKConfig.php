...
class SDKConfig {
    ...
    public function __construct(){
		...
		$this->signCertPath = array_key_exists("acpsdk.signCert.path", $sdk_array)?__DIR__.$sdk_array["acpsdk.signCert.path"]: null;
		...
		$this->encryptCertPath = array_key_exists("acpsdk.encryptCert.path", $sdk_array)? __DIR__.$sdk_array["acpsdk.encryptCert.path"]: null;
		$this->rootCertPath = array_key_exists("acpsdk.rootCert.path", $sdk_array)? __DIR__.$sdk_array["acpsdk.rootCert.path"]: null;
		$this->middleCertPath =  array_key_exists("acpsdk.middleCert.path", $sdk_array)?__DIR__.$sdk_array["acpsdk.middleCert.path"]: null;
